...
pub struct Interaction {
    /// Allow dragging the numeric part of a [`crate::DragValue`] or slider.
    /// Disable on touch editors so a swipe over a number can scroll its parent.
    /// Clicking still opens exact text entry; slider rails remain draggable.
    pub drag_value_dragging: bool,
...
impl Interaction {
    pub fn ui(&mut self, ui: &mut crate::Ui) {
        ...
        ui.checkbox(drag_value_dragging, "Drag numeric values");
