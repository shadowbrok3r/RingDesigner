...
- Native checks: **719 passed** — 438 core tests and 281 other workspace/golden
  checks. The final core run also verifies the exact side-wall selector used by
  the new facet-width regression.
