...
pub fn apply_visuals(style: &mut egui::Style) {
    ...
    v.selection.bg_fill = rgba(59, 40, 69, 245);
...
fn widget_palette(w: &mut egui::style::Widgets) {
    ...
    w.inactive.bg_fill = rgba(25, 22, 32, 185);
    w.inactive.weak_bg_fill = rgba(22, 19, 29, 185);
    w.inactive.bg_stroke = Stroke::new(1.0, RIM_BRIGHT);
    w.inactive.fg_stroke = Stroke::new(1.0, text);
    w.inactive.corner_radius = radius;
    w.hovered.bg_fill = rgba(29, 25, 38, 220);
    w.hovered.weak_bg_fill = rgba(29, 25, 38, 220);
    w.hovered.bg_stroke = Stroke::new(1.5, rgba(43, 226, 214, 240));
    w.hovered.fg_stroke = Stroke::new(1.5, text_bright);
    w.hovered.corner_radius = radius;
    w.active.bg_fill = rgba(42, 25, 40, 235);
    w.active.weak_bg_fill = rgba(42, 25, 40, 235);
    w.active.bg_stroke = Stroke::new(1.7, rgba(255, 61, 139, 245));
    w.active.fg_stroke = Stroke::new(2.0, Color32::WHITE);
    w.active.corner_radius = radius;
    w.open.bg_fill = rgba(25, 22, 32, 185);
    w.open.weak_bg_fill = rgba(22, 19, 29, 185);
...
mod tests {
    ...
    fn the_visuals_are_pink_and_aqua_on_black() {
        ...
        assert_eq!(v.selection.bg_fill, Color32::from_rgba_unmultiplied(59, 40, 69, 245));
