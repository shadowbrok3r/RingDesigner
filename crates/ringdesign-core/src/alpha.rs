...
impl Procedural {
    pub const ALL: &'static [Procedural] = &[
        ...
        Procedural::Scales,
        Procedural::SnakeKeels,
        Procedural::VentralScutes,
        Procedural::CrocodileScutes,
        Procedural::ReptileShields,
        Procedural::GreekKey,
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            Procedural::SnakeKeels => "Snake keels",
            Procedural::VentralScutes => "Ventral scutes",
            Procedural::CrocodileScutes => "Crocodile scutes",
            Procedural::ReptileShields => "Reptile shields",
        ...
        for j in 0..n {
            ...
            for i in 0..n {
                ...
                let v = match self {
                    ...
                    Procedural::SnakeKeels => crate::reptile::snake_tile(x, y),
                    Procedural::VentralScutes => crate::reptile::ventral_tile(x, y),
                    Procedural::CrocodileScutes => crate::reptile::crocodile_tile(x, y),
                    Procedural::ReptileShields => crate::reptile::shield_tile(x, y),
